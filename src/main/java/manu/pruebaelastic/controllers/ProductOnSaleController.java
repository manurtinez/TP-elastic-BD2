...
public class ProductOnSaleController {
    ...
    @PostMapping
    public ProductOnSale createProductOnSale(@RequestBody ProductOnSaleDTO productOnSaleDTO) {
        return this.productOnSaleService.addProductOnSale(productOnSaleDTO);
    }
